...
<!-- One paragraph. What skill file(s) changed and why. -->
...
- [ ] All modified SKILL.md files have valid YAML frontmatter
...
<!-- How did you verify this works? Paste the Claude prompt you used and the output you got. -->
